          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div v-if="preCheckoutUi.suggest" class="mt-2 small">
                ...
                • giảm
                <b class="text-danger">
                  -{{ money(preCheckoutUi.suggest.discount) }}
                </b>
              </div>
            </div>
...
=======
  ...
  activeId.value = localId;
  orderSeq.value++;
>>>>>>> 4ef6f32cd08b047243194257b3c873e88dfae490
}
...
function mapSpct(x) {
  ...
  return {
    ...
    image: buildImgUrl(x.anh || x.anhDaiDien || x.primaryImageUrl || x.mediaAsset) || placeholderImg,
  };
}
...
async function setQtyByInput(cartIndex, nextQtyRaw) {
  ...
  try {
    ...
    if (remain <= 0) {
      ...
      fallbackMsg = `Số lượng mua không được vượt quá số lượng tồn kho còn lại tồn ${remain}`;
    }
